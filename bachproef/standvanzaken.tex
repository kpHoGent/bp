...
Het doel van pose estimation is om de \textbf{3D-positie en oriëntatie} van een object te bepalen op basis van zijn \textbf{2D-projectie} in een afbeelding of video. 
...
\subsection{\IfLanguageName{dutch}{Pose Estimation Modellen}{Pose Estimation Models}}%
\label{subsec:pose-estimation-modellen}
